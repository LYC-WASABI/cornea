...
INPUT = "576w5n_stage576_100_from_0875_lower_dn_scan_summary.csv"
OUTPUT = "576w5n_stage576_100_from_0875_lower_dn_scan_verify_summary.csv"
...
if {"RESET", "REUSE"}.issubset(passed_modes):
    ...
    print("OVERALL_DIAGNOSIS=100_FROM_0875_LOWER_DN_SCAN_HAS_PASS_BOTH")
    ...
    print("OVERALL_DIAGNOSIS=100_FROM_0875_LOWER_DN_SCAN_NOT_CONFIRMED_BOTH")
    raise SystemExit(2)
