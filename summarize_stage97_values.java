...
public class summarize_stage97_values {
  ...
  public static void main(String[] args) {
    try {
      ...
      Model model = ModelUtil.load("Model", "D:\\\\COMSOL_Outputs\\\\models\\\\du\\\\flow\\\\175_lid8mm_stage97_rq0p5um_break0p5to1_results.mph");
      ...
      evalSurface(model, "MinSurface", "lambda", film, cornea, "h_film_input/Rq_eq", "1");
      evalSurface(model, "MaxSurface", "lambda", film, cornea, "h_film_input/Rq_eq", "1");
      ...
      evalSurface(model, "MaxSurface", "lid_contact_pressure", solid, lid, "if(isdefined(solid.Tn),solid.Tn,0)", "Pa");
