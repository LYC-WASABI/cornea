...
public class stage555_phase2_to_020 {
  ...
  public static void main(String[] args) {
    try {
      ...
      Model model = ModelUtil.load(
          "Model", "557a_stage555_phase1_alpha0p05.mph");
      String comp = "comp1";
      String ge = "ge_force_total111";
      String study = "std_coupled555_p2";
      try { model.study().remove(study); } catch (Exception ignored) {}
      model.study().create(study);
      model.study(study).label("Stage 555 continuation 0.05 to 0.20");
      model.study(study).create("param", "Parametric");
      model.study(study).feature("param").set(
          "pname", new String[] {"alpha_gap555"});
      model.study(study).feature("param").set(
          "plistarr", new String[] {
            "0.05 0.052 0.055 0.06 0.07 0.08 0.09 0.10 0.11 0.12 0.14 0.16 0.18 0.20"
          });
      model.study(study).feature("param").set(
          "punit", new String[] {"1"});
      ...
      model.study(study).feature("stat").set("initsol", "sol61");
      model.study(study).feature("stat").set("initsoluse", "sol61");
      ...
      System.out.println("RUN_PHASE2=" + solution);
      model.sol(solution).runAll();
      model.param().set("stage555_phase", "2");
      model.save("557b_stage555_phase2_alpha0p20.mph");
      System.out.println("STAGE555_PHASE2_PASS solution=" + solution);
