...
public class du_arc_length_14_22_iterative_coarse {
  private static final String IN =
      "D:\\COMSOL_Outputs\\models\\du\\du_cornea_lid_geometric_indent_deformable_lid_outer_support_results.mph";
  private static final String SETUP =
      "D:\\COMSOL_Outputs\\models\\du\\35_rect_lid_arc_14_22_iterative_calibration_setup.mph";
  ...
  private static void configureStraightRectangularGeometry(Model model) {
    ...
    model.param().set("delta_indent", "0.0725[mm]", "Geometric indentation calibration parameter");
  ...
  private static double solveForce(Model model, double arcMm, double indentMm) {
    ...
    System.out.println("BOUNDARIES arc=" + arcMm + " indent=" + indentMm
        + " contact=" + Arrays.toString(model.component("comp1")
            .selection("sel_lid_contact_source_robust").entities(2))
        + " support=" + Arrays.toString(model.component("comp1")
            .selection("sel_lid_outer_support").entities(2)));
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    model.label("35_rect_lid_arc_14_22_iterative_calibration_setup.mph");
    clean(model);
    ...
    double[] indents = {0.065, 0.070, 0.0725, 0.075, 0.080};
