...
public class du_flow_lid9_static_preload_final {
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.param().set("delta_indent", "0.0645[mm]");
    ...
    System.out.printf("FINAL_STATIC delta_indent=0.064500[mm] force=%.12f[N]%n", force);
    model.save(OUT);
