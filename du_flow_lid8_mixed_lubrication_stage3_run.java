...
public class du_flow_lid8_mixed_lubrication_stage3_run {
  private static final String IN =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\34_lid8mm_mixed_lubrication_stage3_moving_footprint_setup.mph";
  private static final String OUT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\35_lid8mm_mixed_lubrication_stage3_moving_footprint_results.mph";
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("35_lid8mm_mixed_lubrication_stage3_moving_footprint_results.mph");
    ...
    model.save(OUT);
    System.out.println("SAVED_STAGE2_RESULT=" + OUT);
  }
}
