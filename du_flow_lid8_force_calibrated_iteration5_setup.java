...
public class du_flow_lid8_force_calibrated_iteration5_setup {
  ...
  private static final double RESIDUAL_GAIN = 0.20;
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("28_lid8mm_force_calibrated_iteration5_local_gain020_setup.mph");
    model.func("dr_sched").label("Iteration 5 local radial correction for approximately constant 0.03 N");
