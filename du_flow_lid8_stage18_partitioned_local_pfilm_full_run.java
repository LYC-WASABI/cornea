...
public class du_flow_lid8_stage18_partitioned_local_pfilm_full_run {
  private static final String IN =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\61_lid8mm_stage18_partitioned_local_pfilm_feedback_setup.mph";
  private static final String OUT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\65_lid8mm_stage18_partitioned_local_pfilm_feedback_scale010_verified_0p12s_results.mph";
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("65_lid8mm_stage18_partitioned_local_pfilm_feedback_scale010_verified_0p12s_results.mph");
    model.param().set("scale_partitioned_pfilm", "0.10",
        "Stable continuation scale for replayed local pfilm");
    ...
    model.study("std_partitioned_local_pfilm").feature("time").set("tlist", "range(0,dt_structure_out,0.12)");
    System.out.println("RUN_FULL_STUDY=std_partitioned_local_pfilm");
    ...
    model.result("pg_stage18_pfilm_replay").feature("surf1").selection().named("sel_cornea_anterior_surface");
    ...
    model.save(OUT);
    System.out.println("SAVED_STAGE18_FULL_RESULTS=" + OUT);
  }
}
