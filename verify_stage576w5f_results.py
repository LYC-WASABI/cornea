...
INPUT = "576w5f_stage576_0875_pressure_reset_dn_scan_summary.csv"
OUTPUT = "576w5f_stage576_0875_pressure_reset_dn_scan_verify_summary.csv"
...
if {"RESET", "REUSE"}.issubset(passed_modes):
    ...
    print("OVERALL_DIAGNOSIS=0875_PRESSURE_RESET_DN_SCAN_HAS_PASS_BOTH")
    ...
    print("OVERALL_DIAGNOSIS=0875_PRESSURE_RESET_DN_SCAN_NOT_CONFIRMED_BOTH")
    raise SystemExit(2)
