...
public class du_flow_lid8_force_calibrated_iteration2_setup {
  ...
  private static final String BASE_RESULT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\du_cornea_lid_8mm_force_calibrated_smoothed_gain050_results.mph";
  private static final String OUT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\24_lid8mm_force_calibrated_iteration2_setup.mph";
  private static final double TARGET = 0.03;
  private static final double STIFFNESS_N_PER_MM = 0.8051323301;
  private static final double RESIDUAL_GAIN = 0.65;
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("24_lid8mm_force_calibrated_iteration2_setup.mph");
    model.func("dr_sched").label("Iteration 2 radial correction for approximately constant 0.03 N");
