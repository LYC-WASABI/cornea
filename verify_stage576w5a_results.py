...
INPUT = "576w5a_stage576_075_forward_extension_from_0625_summary.csv"
OUTPUT = "576w5a_stage576_075_forward_extension_from_0625_verify_summary.csv"
...
if {"RESET", "REUSE"}.issubset(passed_modes):
    ...
    print("OVERALL_DIAGNOSIS=075_FORWARD_EXTENSION_PASS_BOTH")
    ...
    print("OVERALL_DIAGNOSIS=075_FORWARD_EXTENSION_NOT_CONFIRMED_BOTH")
    raise SystemExit(2)
