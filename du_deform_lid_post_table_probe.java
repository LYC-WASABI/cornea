...
public class du_deform_lid_post_table_probe {
  public static void main(String[] args) throws java.io.IOException {
    ...
    for (String tag : model.result().table().tags()) {
      ...
      try { System.out.println(Arrays.deepToString(model.result().table(tag).getReal())); } catch (Exception ex) { System.out.println("error=" + ex.getMessage()); }
    }
  }
}
