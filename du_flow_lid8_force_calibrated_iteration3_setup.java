...
public class du_flow_lid8_force_calibrated_iteration3_setup {
  ...
  private static final String BASE_RESULT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\du_cornea_lid_8mm_force_calibrated_iteration2_results.mph";
  ...
  private static final double RESIDUAL_GAIN = 0.75;
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("25_lid8mm_force_calibrated_iteration3_setup.mph");
    model.func("dr_sched").label("Iteration 3 radial correction for approximately constant 0.03 N");
