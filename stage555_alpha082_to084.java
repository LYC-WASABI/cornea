...
public class stage555_alpha082_to084 {
  public static void main(String[] args) {
    try {
      ...
      String study = "std555_alpha084";
      model.study().create(study);
      model.study(study).label("Stage 555 alpha 0.82 to 0.84");
      model.study(study).create("param", "Parametric");
      model.study(study).feature("param").set(
          "pname", new String[] {"alpha_gap555"});
      model.study(study).feature("param").set(
          "plistarr", new String[] {"0.82 0.825"});
      model.study(study).feature("param").set(
          "punit", new String[] {"1"});
      ...
      System.out.println("RUN_ALPHA084=" + solution);
      model.sol(solution).runAll();
      model.save("557q5_stage555_alpha0p825_guided_branch.mph");
      System.out.println("STAGE555_ALPHA084_PASS solution=" + solution);
