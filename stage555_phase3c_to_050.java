...
public class stage555_phase3c_to_050 {
  ...
  public static void main(String[] args) {
    try {
      ...
      Model model = ModelUtil.load(
          "Model", "557d_stage555_phase3b_alpha0p385.mph");
      String comp = "comp1";
      String ge = "ge_force_total111";
      String study = "std_coupled555_p3c";
      model.study().create(study);
      model.study(study).label("Stage 555 micro continuation 0.385 to 0.50");
      ...
      System.out.println("RUN_PHASE3C=" + solution);
      model.sol(solution).runAll();
      model.param().set("stage555_phase", "3.75");
      model.save("557e_stage555_phase3c_alpha0p389.mph");
      System.out.println("STAGE555_PHASE3C_PASS solution=" + solution);
