...
public class du_flow_lid8_force_calibrated_iteration6_setup {
  private static final String BASE_SETUP =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\28_lid8mm_force_calibrated_iteration5_local_gain020_setup.mph";
  private static final String BASE_RESULT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\du_cornea_lid_8mm_force_calibrated_iteration5_local_gain020_results.mph";
  private static final String OUT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\29_lid8mm_force_calibrated_iteration6_local_gain035_setup.mph";
  private static final double TARGET = 0.03;
  private static final double STIFFNESS_N_PER_MM = 0.8051323301;
  private static final double RESIDUAL_GAIN = 0.35;
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("29_lid8mm_force_calibrated_iteration6_local_gain035_setup.mph");
    model.func("dr_sched").label("Iteration 6 local radial correction for approximately constant 0.03 N");
