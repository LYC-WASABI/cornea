...
public class du_arc_length_10_12_iterative_coarse {
  private static final String IN =
      "D:\\COMSOL_Outputs\\models\\du\\du_cornea_lid_geometric_indent_deformable_lid_outer_support_results.mph";
  private static final String SETUP =
      "D:\\COMSOL_Outputs\\models\\du\\32_rect_lid_arc_10_12_iterative_calibration_setup.mph";
  ...
  private static void configureStraightRectangularGeometry(Model model) {
    ...
    model.param().set("delta_indent", "0.06[mm]", "Geometric indentation calibration parameter");
    model.component("comp1").geom("geom1").feature("blk1")
        .label("Straight rectangular cutter: variable 10 or 12 mm arc length x 1 mm width");
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    model.label("32_rect_lid_arc_10_12_iterative_calibration_setup.mph");
    clean(model);
    ...
    double[] arcs = {10.0, 12.0};
    double[] indents = {0.025, 0.035, 0.045, 0.055, 0.065, 0.075, 0.085, 0.095, 0.110};
