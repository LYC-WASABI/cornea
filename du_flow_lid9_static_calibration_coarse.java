...
public class du_flow_lid9_static_calibration_coarse {
  ...
  private static final String SETUP =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\08_lid9mm_static_preload_calibration_setup.mph";
  private static final String THETA_LIST =
      "0 -2.5 -5 -7.5 -10 -12.5 -15 -17.5 -20 -22.5 -25 -27.5 -30 -32.5 -35";

  public static void main(String[] args) throws Exception {
    ModelUtil.initStandalone(true);
    double[] deltas = new double[]{0.020, 0.030, 0.040, 0.050, 0.060, 0.070, 0.080};

    Model setup = configuredModel("Setup", 0.050);
    setup.save(SETUP);
  ...
  private static void createStudy(Model model) {
    ...
    model.study("std_preload").label("Static preload calibration at scratch start");
