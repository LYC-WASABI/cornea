...
public class du_flow_lid8_mixed_lubrication_stage5_partitioned_film_run {
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("38_lid8mm_mixed_lubrication_stage5_partitioned_film_h6um_results.mph");
    model.param().set("h0_tear", "6[um]", "Partitioned mixed-lubrication film thickness trial");
