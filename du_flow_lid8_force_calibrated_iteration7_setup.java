...
public class du_flow_lid8_force_calibrated_iteration7_setup {
  ...
  private static final String BASE_RESULT =
      "D:\\COMSOL_Outputs\\models\\du\\flow\\du_cornea_lid_8mm_force_calibrated_iteration6_local_gain035_results.mph";
  ...
  private static final double RESIDUAL_GAIN = 0.50;
  ...
  public static void main(String[] args) throws Exception {
    ...
    model.label("30_lid8mm_force_calibrated_iteration7_local_gain050_setup.mph");
    model.func("dr_sched").label("Iteration 7 local radial correction for approximately constant 0.03 N");
