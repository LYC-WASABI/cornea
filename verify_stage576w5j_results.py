...
INPUT = "576w5j_stage576_08125_pressure_reset_high_dn_scan_summary.csv"
OUTPUT = "576w5j_stage576_08125_pressure_reset_high_dn_scan_verify_summary.csv"
...
if {"RESET", "REUSE"}.issubset(passed_modes):
    ...
    print("OVERALL_DIAGNOSIS=08125_PRESSURE_RESET_HIGH_DN_SCAN_HAS_PASS_BOTH")
    ...
    print("OVERALL_DIAGNOSIS=08125_PRESSURE_RESET_HIGH_DN_SCAN_NOT_CONFIRMED_BOTH")
    raise SystemExit(2)
