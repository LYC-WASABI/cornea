...
INPUT = "576w5e_stage576_100_forward_extension_from_075_summary.csv"
OUTPUT = "576w5e_stage576_100_forward_extension_from_075_verify_summary.csv"
...
if {"RESET", "REUSE"}.issubset(passed_modes):
    ...
    print("OVERALL_DIAGNOSIS=100_FORWARD_EXTENSION_PASS_BOTH")
    ...
    print("OVERALL_DIAGNOSIS=100_FORWARD_EXTENSION_NOT_CONFIRMED_BOTH")
    raise SystemExit(2)
