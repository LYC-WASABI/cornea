...
public class stage101_force_control_total_load_run_v2 {
  ...
  private static void setupFullyCoupled(Model m, String solTag) {
    try {
      ...
      try { t1.feature("fc1").set("dtech", "auto"); } catch (Exception ignore) {}
    } catch (Exception e) {
      System.out.println("WARN fully coupled setup failed: " + e.getMessage());
    }
  }
  ...
  public static void main(String[] args) {
    try {
      ...
      m.component(c).physics("ge_force_total101").feature("ge1").set("equation", 1, 1, "(Fn_total101-F_total_target)/F_total_target");
      ...
      System.out.println("STAGE101_SOLVER=" + solTag);
      setupFullyCoupled(m, solTag);
      System.out.println("RUN_STAGE101_V2_FULLY_COUPLED");
      m.sol(solTag).runAll();
      ...
      addGlobalPlot(m, "pg101_total_normal_load_time", "Stage 101 total normal load control over time", dset,
          new String[]{"Fn_contact101", "W_film_replay53", "Fn_total101", "F_total_target"},
          new String[]{"N", "N", "N", "N"});
      addGlobalPlot(m, "pg101_total_normal_load_error", "Stage 101 total normal load error and indentation", dset,
      ...
      addEval(m, "eval101_total_normal_load", "Stage 101 total normal load control values", dset,
      ...
      m.save("179_lid8mm_stage101_total_load_force_control_results_Model.mph");
      System.out.println("Saved local: 179_lid8mm_stage101_total_load_force_control_results_Model.mph");
