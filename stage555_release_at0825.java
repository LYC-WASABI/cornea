...
public class stage555_release_at0825 {
  public static void main(String[] args) {
    try {
      ...
      String study = "std555_release0825";
      model.study().create(study);
      model.study(study).label(
          "Stage 555 restore true load control at alpha 0.825");
      model.study(study).create("param", "Parametric");
      model.study(study).feature("param").set(
          "pname", new String[] {"eps_q_regular555"});
      model.study(study).feature("param").set(
          "plistarr", new String[] {
            "100 80 60 40"
          });
      ...
      System.out.println("RUN_RELEASE0825=" + solution);
      model.sol(solution).runAll();
      model.save("557s1_stage555_alpha0p825_eps40.mph");
      System.out.println("STAGE555_RELEASE0825_PASS solution=" + solution);
